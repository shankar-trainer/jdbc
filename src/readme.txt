mvn install:install-file -DgroupId=com.oracle -Dartifact
Id=ojdbc6 -Dversion=11.2.0.3 -Dpackaging=jar -Dfile=c:\Users\admin\Desktop\ojdbc
6.jar -DgeneratePom=true
